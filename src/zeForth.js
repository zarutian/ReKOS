...
const src3 = `
  ...
  .db 0x04 0x0C 0x00 0x02 # 0x001E 0x4C02   Branch to 0x0038 if Carry is off
  ...
  .dhw 0x4C02 # 0x03E2 0x4C02   BRanch if Carry Zero
  .dhw 0x0421 # 0x03E3 0x0421
  .dhw 0xD400 # 0x03E4 0xD400   STO_l
  .dhw 0x041A # 0x03E5 0x041A   address of SCA_ISR_tmp2
  .dhw 0xC400 # 0x03E6 0xC400   LD_l
  .dhw 0x____ # 0x03E7 0x____   address of BSC_rx_addr+1, the length
  .dhw 0x4C20 # 0x03E8 0x4C20   BRAZ
  .dhw 0x0421 # 0x03E9 0x0421
  .dhw 0x9400 # 0x03EA 0x9400   SUBTRACT_l
  .dhw 0x02B5 # 0x03EB 0x02B5   address of constant 1
  .dhw 0xD400 # 0x03EC 0xD400   STO_l
  .dhw 0x____ # 0x03ED 0x____   address of BSC_rx_addr+1, the length
  .dhw 0xC400 # 0x03EE 0xC400   LD_l
  .dhw 0x03CF # 0x03EF 0x03CF   address of BSC_rx_addr
  .dhw 0x4C04 # 0x03F0 0x4C04   BRanch if Accumulator is EVen
  .dhw 0x0414 # 0x03F1 0x0414   branch target
  .dhw 0xC400 # 0x03F2 0xC400   LD_l                     BSC_rx_addr is odd
  .dhw 0x____ # 0x03F3 0x____   address of SCA_ISR_tmp3  check if we got the odd nr'ed byte
  .dhw 0xE400 # 0x03F4 0xE400   AND_l
  .dhw 0x02B5 # 0x03F4 0x02B5   address of constant 1
  .dhw 0x4C20 # 0x03F5 0x4C20   BRAZ
  .dhw 0x040B # 0x03F6 0x040B 
  .dhw 0xC400 # 0x03F7 0xC400   LD_l                     we did get the odd nr'ed byted
  .dhw 0x____ # 0x03F8 0x____   address of BSC_rx_addr   get where to put it
  .dhw 0x1801 # 0x03F9 0x1801   SRL 1  half it!          convert that byte address to cell address
  .dhw 0xD400 # 0x03FA 0xD400   STO_l                    self modify code to plonk it in
  .dhw 0x0402 # 0x03FB 0x0402
  .dhw 0xD400 # 0x03FC 0xD400   STO_l
  .dhw 0x0404 # 0x03FD 0x0404
  .dhw 0xC400 # 0x03FE 0xC400   LD_l                     get the byte itself
  .dhw 0x____ # 0x03FF 0x____   address of SCA_ISR_tmp3
  .dhw 0x1808 # 0x0400 0x1808   SRL 8                    shift it to correct place in the cell
  .dhw 0xEC00 # 0x0401 0xEC00   OR_l                     OR the original cell
  .dhw 0xDEAD # 0x0402 0xDEAD   will be replaced
  .dhw 0xD400 # 0x0403 0xD400   STO_l                    store the updated cell
  .dhw 0xDEAD # 0x0404 0xDEAD   will be replaced
  .dhw 0xC400 # 0x0405 0xC400   LD_l
  .dhw 0x02B5 # 0x0406 0x02B5   address of constant_1
  .dhw 0xD400 # 0x0407 0xD400   STO_l                    
  .dhw 0x____ # 0x0408 0x____   address of SCA_ISR_tmp3
  .dhw 0x6400 # 0x0409 0x6400   LDX_l IA
  .dhw 0x0421 # 0x040A 0x0421
  .dhw 0xC400 # 0x040B 0xC400   LD_l                     we have not gotted the odd nr'ed byte yet
  .dhw 0x____ # 0x040C 0x____   address of address of SCA_ISR_tmp3
  .dhw 0xD400 # 0x040D 0xD400   STO_l                    so request it
  .dhw 0x____ # 0x040E 0x____   address of BSC_read_IOCC
  .dhw 0x0C00 # 0x040F 0x0C00   XIO_l
  .dhw 0x0___ # 0x0410 0x0___   address of BSC_read_IOCC
  .dhw 0x6400 # 0x0412 0x6400   LDX_l IA
  .dhw 0x044D # 0x0413 0x044D
  .dhw 0xC400 # 0x0414 0xC400   LD_l
  .dhw 0x____ # 0x0415 0x____   address of BSC_rx_addr
  .dhw 0x1801 # 0x0416 0x1801   SRL 1
  .dhw 0xD400 # 0x0417 0xD400   STO_l
  .dhw 0x____ # 0x0418 0x____   address of BSC_read_IOCC
  .dhw 0xC400 # 0x0419 0xC400   LD_l
  .dhw 0x____ # 0x041A 0x____   address of BSC_rx_addr
  .dhw 0x8400 # 0x041B 0x8400   ADD_l
  .dhw 0x02B5 # 0x041C 0x02B5   address of constant 1
  .dhw 0xD400 # 0x041D 0xD400   STO_l
  .dhw 0x0___ # 0x041E 0x0___   address of BSC_rx_addr
  .dhw 0x0C00 # 0x041F 0x0C00   XIO_l
  .dhw 0x041F # 0x0420 0x041F   address of BSC_read_IOCC
  .dhw 0xC400 # 0x0421 0xC400   LD_l
  .dhw 0x041A # 0x0422 0x041A   address of SCA_ISR_tmp2
  .dhw 0x1001 # 0x0423 0x1001   SLA 1
  .dhw 0x4C02 # 0x0424 0x4C02   BRCZ
  .dhw 0x0___ # 0x0425 0x0___
  .dhw 0xD400 # 0x0426 0xD400   STO_l
  .dhw 0x0___ # 0x0427 0x0___   address of SCA_ISR_tmp2
  .dhw 0xC400 # 0x0428 0xC400   LD_l
  .dhw 0x0___ # 0x0429 0x0___   address of BSC_tx_addr+1, the length
  .dhw 0x4C20 # 0x042A 0x4C20   BRAZ
  .dhw 0x0___ # 0x042B 0x0411 
  .dhw 0x9400 # 0x042C 0x9400   SUBTRACT_l
  .dhw 0x02B5 # 0x042D 0x02B5   address of constant 1
  .dhw 0xD400 # 0x042E 0xD400   STO_l
  .dhw 0x0___ # 0x042F 0x0___   address of BSC_tx_addr+1, the length
  .dhw 0xC400 # 0x0430 0xC400   LD_l
  .dhw 0x0___ # 0x0431 0x0___   address of BSC_tx_addr
  .dhw 0x4C04 # 0x0432 0x4C04   BRanch if Accumulator is EVen
  .dhw 0x0___ # 0x0433 0x0___
  .dhw 0x1801 # 0x0434 0x1801   SRL 1
  .dhw 0xD400 # 0x0435 0xD400   STO_l
  .dhw 0x0438 # 0x0436 0x0438
  .dhw 0xC400 # 0x0437 0xC400   LD_l
  .dhw 0xDEAD # 0x0438 0xDEAD   gets replaced
  .dhw 0x1008 # 0x0439 0x1008   SLA 8
  .dhw 0xD400 # 0x043A 0xD400   STO_l
  .dhw 0x0___ # 0x043B 0x0___   address of SRA_ISR_tmp4
  .dhw 0xC400 # 0x043C 0xC400   LD_l
  .dhw 0x____ # 0x043D 0x____   address of address of SRA_ISR_tmp4
  .dhw 0x6400 # 0x043E 0x6400   LDX_l IA
  .dhw 0x0443 # 0x043F 0x0443
  .dhw 0xC400 # 0x0440 0xC400   LD_l
  .dhw 0x____ # 0x0441 0x____   address of BSC_tx_addr
  .dhw 0x1801 # 0x0442 0x1801   SRL 1
  .dhw 0xD400 # 0x0443 0xD400   STO_l
  .dhw 0x____ # 0x0444 0x____   address of BSC_write_IOCC
  .dhw 0x0C00 # 0x0445 0x0C00   XIO_l
  .dhw 0x0___ # 0x0446 0x0___   address of BSC_write_IOCC
  .dhw 0xC400 # 0x0447 0xC400   LD_l
  .dhw 0x____ # 0x0448 0x____   address of BSC_tx_addr
  .dhw 0x8400 # 0x0449 0x8400   ADD_l
  .dhw 0x02B5 # 0x044A 0x02B5   address of constant 1
  .dhw 0xD400 # 0x044B 0xD400   STO_l
  .dhw 0x03CF # 0x044C 0x03CF   address of BSC_tx_addr
  .dhw 0xC400 # 0x044D 0xC400   LD_l
  .dhw 0x041A # 0x044E 0x041A   address of SCA_ISR_tmp2
  .dhw 0xE800 # 0x044F 0xE800   OR_l
  .dhw 0x02B5 # 0x0450 0x02B5   address of constant 1
  .dhw 0xD400 # 0x0451 0xD400   STO_l
  .dhw 0x041A # 0x0452 0x041A   address of SCA_ISR_tmp2
  .dhw 0x6400 # 0x0453 0x6400   LDX_l IA
  .dhw 0x03D2 # 0x0454 0x03D2
  .dhw 0x01A0 # 0x0455 0x01A0   (VAR) : SCA_ISR_status
  .dhw 0x0BEE # 0x0456 0x0BEE   SCA_ISR_tmp2
  .dhw 0x0000 # 0x0457 0x0000   SCA_ISR_tmp3
  .dhw 0x0000 # 0x0458 0x0000   SCA_ISR_tmp5
  .dhw 0x01A0 # 0x0459 0x01A0   (VAR)
  .dhw 0x0000 # 0x045A 0x0000   SCA_Sense_IOCC
  .dhw 0x5700 # 0x045B 0x5700
  .dhw 0x01A0 # 0x045C 0x01A0   (VAR)
  .dhw 0xDEAD # 0x045D 0xDEAD   BSC_read_IOCC
  .dhw 0x5200 # 0x045E 0x5200
  .dhw 0x01A0 # 0x045F 0x01A0   (VAR)
  .dhw 0xDEAD # 0x0460 0xDEAD   BSC_write_IOCC
  .dhw 0x5100 # 0x0461 0x5100
  .dhw 0x013B # 0x0462 0x013B   (CONST)   : BSC_init_read_IOCC2
  .dhw 0x5601 # 0x0463 0x5601
  .dhw 0x013B # 0x0464 0x013B   (CONST)   : BSC_init_write_IOCC2
  .dhw 0x5540 # 0x0465 0x5540
  .dhw 0x013B # 0x0466 0x013B   (CONST)   : BSC_ctrl_IOCC2
  .dhw 0x5400 # 0x0467 0x5400
  .dhw 0x013B # 0x0468 0x013B   (CONST)   : BSC_set_syncchar_IOCC2
  .dhw 0x5104 # 0x0469 0x5104
  .dhw 0x01A0 # 0x046A 0x01A0   (VAR)     : BSC_rx_addr
  .dhw 0x0000 # 0x046B 0x0000   addr
  .dhw 0x0000 # 0x046C 0x0000   length
  .dhw 0x013B # 0x046D 0x013B   (CONST)   : 0x1600_const
  .dhw 0x1600 # 0x046E 0x1600
  .dhw 0x042F # 0x046F 0x042F   0x1600_const   : BSC_init
  .dhw 0x01C1 # 0x0470 0x01C1   SP@
  .dhw 0x042A # 0x0471 0x042A   BSC_set_syncchar_IOCC2
  .dhw 0x019A # 0x0472 0x019A   (IO)
  .dhw 0x0009 # 0x0473 0x0009   DROP           SYNc char set
  .dhw 0x0170 # 0x0474 0x0170   FALSE
  .dhw 0x0428 # 0x0475 0x0428   BSC_ctrl_IOCC2
  .dhw 0x0454 # 0x0476 0x0454   0x14_const
  .dhw 0x0187 # 0x0477 0x0187   OR
  .dhw 0x019A # 0x0478 0x019A   (IO)
  .dhw 0x0009 # 0x0479 0x0009   DROP           SCA modes set
  .dhw 0x0442 # 0x047A 0x0442   (LIT)
  .dhw 0x03D6 # 0x047B 0x03D6
  .dhw 0x0442 # 0x047C 0x0442   (LIT)
  .dhw 0x0009 # 0x047D 0x0009
  .dhw 0x0007 # 0x047E 0x0007   !              pointer to SCA ISR set
  .dhw 0x000F # 0x047F 0x000F   EXIT
  .dhw 0x000D # 0x0480 0x000D   R>   : (LIT)  ( -- value )
  .dhw 0x0008 # 0x0481 0x0008   DUP
  .dhw 0x0005 # 0x0482 0x0004   1+
  .dhw 0x000C # 0x0483 0x000C   >R
  .dhw 0x0006 # 0x0484 0x0006   @
  .dhw 0x000F # 0x0485 0x000F   EXIT
  .dhw 0x02B5 # 0x0486 0x02B5   1_const : 0xFFFE_const
  .dhw 0x0177 # 0x0487 0x0177   INVERT
  .dhw 0x000F # 0x0488 0x000F   EXIT
  .dhw 0x0004 # 0x0489 0x0004   1<<>   : 1<<
  .dhw 0x0448 # 0x048A 0x0448   0xFFFE_const
  .dhw 0x0002 # 0x048B 0x0002   &
  .dhw 0x000F # 0x048C 0x000F   EXIT
  .dhw 0x000C # 0x048D 0x000C   >R   : ROT  ( a b c -- b c a )
  .dhw 0x000A # 0x048E 0x000A   SWAP
  .dhw 0x000D # 0x048F 0x000D   R>
  .dhw 0x000A # 0x0490 0x000A   SWAP
  .dhw 0x000F # 0x0491 0x000F   EXIT
  .dhw 0x013B # 0x0492 0x013B   (CONST)   : 0x14_const
  .dhw 0x0014 # 0x0493 0x0014
  .dhw 0x000C # 0x0494 0x000C   >R   : PACKBYTES ( src_addr dest_addr length_in_cells -- )
  .dhw 0x0___ # 0x0495 0x0___   (JMP)
  .dhw 0x0466 # 0x0496 0x0466
  .dhw 0x014A # 0x0497 0x014A   OVER     ( src dest src )
  .dhw 0x0006 # 0x0498 0x0006   @        ( src dest 0xXX__ )
  .dhw 0x000C # 0x0499 0x000C   >R       ( src dest )
  .dhw 0x046A # 0x049A 0x046A   incr_NOS ( src+1 dest )
  .dhw 0x014A # 0x049B 0x014A   OVER     ( src+1 dest src+1 )
  .dhw 0x0006 # 0x049C 0x0006   @        ( src+1 dest 0xXX__ )
  .dhw 0x0___ # 0x049D 0x0___   8<<>     ( src+1 dest 0x__XX )
  .dhw 0x000D # 0x049E 0x000D   R>       ( src+1 dest 0x__XX 0xXX__ )
  .dhw 0x0003 # 0x049F 0x0003   XOR      ( src+1 dest 0xXXXX )
  .dhw 0x014A # 0x04A0 0x014A   OVER     ( src+1 dest 0xXXXX dest )
  .dhw 0x0007 # 0x04A1 0x0007   !        ( src+1 dest )
  .dhw 0x0005 # 0x04A2 0x0005   1+       ( src+1 dest+1 )
  .dhw 0x046A # 0x04A3 0x046A   incr_NOS ( src+2 dest+1 )
  .dhw 0x0___ # 0x04A4 0x0___   (NEXT)
  .dhw 0x0459 # 0x04A5 0x0459
  .dhw 0x0___ # 0x04A6 0x0___   (JMP)
  .dhw 0x0___ # 0x04A7 0x0___   2DROP
  .dhw 0x000A # 0x04A8 0x000A   SWAP   : incr_NOS
  .dhw 0x0005 # 0x04A9 0x0005   1+
  .dhw 0x000A # 0x04AA 0x000A   SWAP
  .dhw 0x000F # 0x04AB 0x000F   EXIT
  .dhw 0x000C # 0x04AC 0x000C   >R     : UNPACKBYTES ( src_addr dest_addr length_in_bytes -- )
  .dhw 0x000A # 0x04AD 0x000A   SWAP     ( dest_addr src_addr )
  .dhw 0x0___ # 0x04AE 0x0___   1<<      ( dest_addr src_byteaddr )
  .dhw 0x000A # 0x04AF 0x000A   SWAP     ( src dest )
  .dhw 0x0___ # 0x04B0 0x0___   (JMP)
  .dhw 0x047B # 0x04B1 0x047B
  .dhw 0x014A # 0x04B2 0x014A   OVER     ( src dest src )
  .dhw 0x0___ # 0x04B3 0x0___   C@       ( src dest byte )
  .dhw 0x0___ # 0x04B4 0x0___   8<<>
  .dhw 0x014A # 0x04B5 0x014A   OVER     ( src dest cell dest )
  .dhw 0x0007 # 0x04B6 0x0007   !        ( src dest )
  .dhw 0x0005 # 0x04B7 0x0005   1+       ( src dest+1 )
  .dhw 0x046A # 0x04B8 0x046A   incr_NOS ( src+1 dest+1 )
  .dhw 0x0___ # 0x04B9 0x0___   (NEXT)
  .dhw 0x0474 # 0x04BA 0x0474
  .dhw 0x0___ # 0x04BB 0x0___   (JMP)
  .dhw 0x0___ # 0x04BC 0x0___   2DROP
  .dhw 0x03CE # 0x04BD 0x03CE   BSC_tx_addr   : BSC_ready?
  .dhw 0x0005 # 0x04BE 0x0005   1+
  .dhw 0x0006 # 0x04BF 0x0006   @
  .dhw 0x0___ # 0x04C0 0x0___   (BRZ)     wait for previous send to finish
  .dhw 0x0486 # 0x04C1 0x0486
  .dhw 0x0___ # 0x04C2 0x0___   (JMP)
  .dhw 0x047F # 0x04C3 0x047F
  .dhw 0x042C # 0x04C4 0x042C   BSC_rx_addr
  .dhw 0x0005 # 0x04C5 0x0005   1+
  .dhw 0x0006 # 0x04C6 0x0006   @
  .dhw 0x0___ # 0x04C7 0x0___   (BRZ)     wait for previous recieve to finish
  .dhw 0x048B # 0x04C8 0x048B
  .dhw 0x0___ # 0x04C9 0x0___   (JMP)
  .dhw 0x0486 # 0x04CA 0x0486
  .dhw 0x0419 # 0x04CB 0x0419   SCA_ISR_status
  .dhw 0x0006 # 0x04CC 0x0006   @
  .dhw 0x0___ # 0x04CD 0x0___   1_const
  .dhw 0x0002 # 0x04CE 0x0002   &
  .dhw 0x0___ # 0x04CF 0x0___   (BRZ)
  .dhw 0x048B # 0x04D0 0x048B
  .dhw 0x0419 # 0x04D1 0x0418   SCA_ISR_status
  .dhw 0x0006 # 0x04D2 0x0006   @
  .dhw 0x0___ # 0x04D3 0x0___   0x0400_const
  .dhw 0x0002 # 0x04D4 0x0002   &
  .dhw 0x0___ # 0x04D5 0x0___   (BRZ)
  .dhw 0x048B # 0x04D6 0x048B
  .dhw 0x000F # 0x04D7 0x000F   EXIT
  .dhw 0x0___ # 0x04D8 0x0___   BSC_ready?   : BSC_send ( addr length -- )
  .dhw 0x03CE # 0x04D9 0x03CE   BSC_tx_addr
  .dhw 0x0___ # 0x04DA 0x0___   D!
  .dhw 0x0___ # 0x04DB 0x0___   FALSE
  .dhw 0x0___ # 0x04DC 0x0___   BSC_init_write_IOCC2
  .dhw 0x0___ # 0x04DD 0x0___   (IO)
  .dhw 0x0009 # 0x04DE 0x0009   DROP
  .dhw 0x000F # 0x04DF 0x000F   EXIT
  .dhw 0x0___ # 0x04E0 0x0___   BSC_ready?   : BSC_recieve ( addr length -- )
  .dhw 0x042C # 0x04E1 0x042C   BSC_rx_addr
  .dhw 0x0___ # 0x04E2 0x0___   D!
  .dhw 0x0___ # 0x04E3 0x0___   FALSE
  .dhw 0x0___ # 0x04E4 0x0___   BSC_init_read_IOCC2
  .dhw 0x0___ # 0x04E5 0x0___   (IO)
  .dhw 0x0009 # 0x04E6 0x0009   DROP
  .dhw 0x000F # 0x04E7 0x000F   EXIT
  .dhw 0x0431 # 0x04E8 0x0431   BSC_init   : remotely_controlled_via_BSC
  .dhw 0x0___ # 0x04E9 0x0___   BSC_greeting
  .dhw 0x0008 # 0x04EA 0x0008   DUP
  .dhw 0x0005 # 0x04EB 0x0005   1+
  .dhw 0x000A # 0x04EC 0x000A   SWAP
  .dhw 0x0006 # 0x04ED 0x0006   @
  .dhw 0x0___ # 0x04EE 0x0___   BSC_send
  .dhw 0x0___ # 0x04EF 0x0___   0xF00_const
  .dhw 0x0___ # 0x04F0 0x0___   4_const
  .dhw 0x0___ # 0x04F1 0x0___   BSC_recieve
  .dhw 0x0___ # 0x04F2 0x0___   0xF00_const
  .dhw 0x0___ # 0x04F3 0x0___   0xC00_const
  .dhw 0x0___ # 0x04F4 0x0___   2_const
  .dhw 0x0___ # 0x04F5 0x0___   NOP
  .dhw 0x0___ # 0x04F6 0x0___   0xC00_const
  .dhw 0x0005 # 0x04F7 0x0005   1+
  .dhw 0x0006 # 0x04F8 0x0006   @
  .dhw 0x0___ # 0x04F9 0x0___   (BRZ)
  .dhw 0x04C9 # 0x04FA 0x04CA
  .dhw 0x0___ # 0x04FB 0x0___   0xC00_const
  .dhw 0x0008 # 0x04FC 0x0008   DUP
  .dhw 0x0006 # 0x04FD 0x0006   @
  .dhw 0x000A # 0x04FE 0x000A   SWAP
  .dhw 0x0005 # 0x04FF 0x0005   1+
  .dhw 0x000A # 0x0500 0x000A   @
  .dhw 0x0___ # 0x0501 0x0___   2DUP
  .dhw 0x0___ # 0x0502 0x0___   1<<
  .dhw 0x0___ # 0x0503 0x0___   BSC_recieve
  .dhw 0x0___ # 0x0504 0x0___   OVER
  .dhw 0x000A # 0x0505 0x000A   SWAP
  .dhw 0x0___ # 0x0506 0x0___   NOP
  .dhw 0x0___ # 0x0507 0x0___   (JMP)
  .dhw 0x04AF # 0x0508 0x04AF
  .dhw 0x0___ # 0x0509 0x0___   0xC00_const
  .dhw 0x0___ # 0x050A 0x0___   @EXECUTE
  .dhw 0x0___ # 0x050B 0x0___   (JMP)
  .dhw 0x04AF # 0x050C 0x04AF
  ...
  .dhw 0x____ # 0x1150 0x____   (CONST)  : pen_colour_black aka 0_const
  .dhw 0x0000 # 0x1151 0x0000
  .dhw 0x____ # 0x1152 0x____   (CONST)  : pen_colour_cyan aka 0x100_const
  .dhw 0x0100 # 0x1153 0x0100
  .dhw 0x____ # 0x1154 0x____   (CONST)  : pen_colour_yellow aka 0x200_const
  .dhw 0x0200 # 0x1155 0x0200
  .dhw 0x____ # 0x1156 0x____   (CONST)  : pen_colour_magenta aka 0x300_const
  .dhw 0x0300 # 0x1157 0x0300

  # pen colour is ored with pen lower commands to select which pen to lower
  ...
  .dhw 0x____ # 0x2056 0x____   232_const
  .dhw 0x____ # 0x2058 0x____   MEMCMP
  .dhw 0x____ # 0x2059 0x____   (BRZ)
  .dhw 0x____ # 0x205A 0x____   DISK_write_sector
  .dhw 0x0009 # 0x205B 0x0009   DROP
  .dhw 0x000F # 0x205X 0x000F   EXIT

  .dhw 0x____ # 0x____ 0x____   FALSE   : MEMCMP ( src_A_addr src_B_addr length -- bool )
  .dhw 0x000C # 0x____ 0x000C   >R
  .dhw 0x000C # 0x____ 0x000C   >R
  .dhw 0x____ # 0x____ 0x____   (JMP)
  .dhw 0x____ # 0x____ 0x____   MEMCMP_L1
  .dhw 0x____ # 0x____ 0x____   OVER             ( src_A src_B src_A )  : MEMCMP_L0
  .dhw 0x0006 # 0x____ 0x0006   @                ( src_A src_B cell_A )
  .dhw 0x____ # 0x____ 0x____   OVER             ( src_A src_B cell_A src_B )
  .dhw 0x0006 # 0x____ 0x0006   @                ( src_A src_B cell_A cell_B )
  .dhw 0x0003 # 0x____ 0x0003   XOR              ( src_A src_B cell )
  .dhw 0x000D # 0x____ 0x000D   R>               ( src_A src_B cell count )
  .dhw 0x000D # 0x____ 0x000D   R>               ( src_A src_B cell count bool )
  .dhw 0x000A # 0x____ 0x000A   SWAP             ( src_A src_B cell bool count )
  .dhw 0x000C # 0x____ 0x000C   >R               ( src_A src_B cell bool )
  .dhw 0x____ # 0x____ 0x____   OR               ( src_A src_B bool )
  .dhw 0x000D # 0x____ 0x000D   R>
  .dhw 0x000A # 0x____ 0x000A   SWAP
  .dhw 0x000C # 0x____ 0x000C   >R
  .dhw 0x000C # 0x____ 0x000C   >R
  .dhw 0x____ # 0x____ 0x____   (NEXT)   : MEM_L1
  .dhw 0x____ # 0x____ 0x____   MEMCMP_L1
  .dhw 0x000D # 0x____ 0x000D   R>
  ...
  .dhw 0x0008 # 0x____ 0x0008   DUP     ( sum sum )
  .dhw 0x____ # 0x____ 0x____   9_const ( sum sum 9 )
  .dhw 0x____ # 0x____ 0x____   >       ( sum bool )
  .dhw 0x000C # 0x____ 0x000C   >R      ( sum ) R:( bool )
  .dhw 0x____ # 0x____ 0x____   FALSE   ( sum 0 )
  .dhw 0x____ # 0x____ 0x____   9_const ( sum 0 9 ) R:( bool )
  .dhw 0x____ # 0x____ 0x____   R@      ( sum 0 9 bool ) R:( bool )
  .dhw 0x____ # 0x____ 0x____   ?:      ( sum subtractand ) R:( bool )
  .dhw 0x____ # 0x____ 0x____   -       ( sum' ) R:( bool )
  .dhw 0x____ # 0x____ 0x____   FALSE   ( sum' 0 )
  ...
  .dhw 0x000A # 0x____ 0x000A   SWAP
  .dhw 0x000F # 0x____ 0x000F   EXIT    # ABCD -> DABC -> CDAB -> BCDA -> ABCD
  .dhw 0x____ # 0x____ 0x____   1_const   : BCD_1+ ( bcd -- bcd+1 carry )
  .dhw 0x____ # 0x____ 0x____   (JMP)
  .dhw 0x____ # 0x____ 0x____   BCD_+
  .dhw 0x____ # 0x____ 0x____   BCD_1+    : BCD_1+D ( BCD_u BCD_l -- BCD_u' BCD_l' )
  .dhw 0x____ # 0x____ 0x____   ROT
  .dhw 0x____ # 0x____ 0x____   BCD_+_
  .dhw 0x0009 # 0x____ 0x0009   DROP
  .dhw 0x000F # 0x____ 0x000F   EXIT
  
  .dhw 0x0008 # 0x____ 0x0008   DUP  : BCD_1+D! ( vaddr -- )
  .dhw 0x000C # 0x____ 0x000C   >R      ( vaddr ) R:( vaddr )
  .dhw 0x____ # 0x____ 0x____   D@      ( BCD_u BCD_l ) R:( vaddr )
  .dhw 0x____ # 0x____ 0x____   BCD_1+D ( BCD_u' BCD_l' )
  .dhw 0x000D # 0x____ 0x000D   R>      ( BCD_u' BCD_l' vaddr ) R:( )
  .dhw 0x____ # 0x____ 0x____   D!      ( )
  .dhw 0x000F # 0x____ 0x000F   EXIT
  
  .dhw 0x____ # 0x____ 0x____   0xF&   : BCD_digit_TO_IBM_CARDCODE ( bcd -- ibm_cc )
  .dhw 0x____ # 0x____ 0x____   0x2000_const
  .dhw 0x000A # 0x____ 0x000A   SWAP
  .dhw 0x____ # 0x____ 0x____   >>
  .dhw 0x000F # 0x____ 0x000F   EXIT

  .dhw 0x____ # 0x____ 0x____   (VAR)  : CARD_NR
  .dhw 0x0000 # 0x____ 0x0000
  .dhw 0x0001 # 0x____ 0x0001

  .dhw 0x____ # 0x____ 0x____   (CONST)   : ibm1442_ctrl_start_punch_IOCC2
  .dhw 0x1401 # 0x____ 0x1401
  .dhw 0x____ # 0x____ 0x____   (CONST)   : ibm1442_sense_device_IOCC2
  ...
  .dhw 0x____ # 0x____ 0x____   (IO)
  .dhw 0x____ # 0x____ 0x____   0x4003_const
  .dhw 0x0002 # 0x____ 0x0002   &
  .dhw 0x____ # 0x____ 0x____   0x4000_const
  .dhw 0x____ # 0x____ 0x____   =
  .dhw 0x____ # 0x____ 0x____   (BRZ)
  .dhw 0x____ # 0x____ 0x____   ibm1442_wait_until_ready_to_punch
  .dhw 0x000F # 0x____ 0x000F   EXIT

  .dhw 0x____ # 0x____ 0x____   (CONST)   : 80_const
  .dhw 0x0050 # 0x____ 0x0050
  .dhw 0x____ # 0x____ 0x____   (VAR)  : ibm1442_columns_left
  .dhw 0x____ # 0x____ 0x____   
  .dhw 0x____ # 0x____ 0x____   ibm1442_wait_until_ready_to_punch   : ibm1442_punch ( ibm_cardcode -- )
  .dhw 0x____ # 0x____ 0x____   8_const
  .dhw 0x____ # 0x____ 0x____   FALSE
  .dhw 0x____ # 0x____ 0x____   ibm1442_columns_left
  .dhw 0x0006 # 0x____ 0x0006   @
  .dhw 0x____ # 0x____ 0x____   ?:
  .dhw 0x____ # 0x____ 0x____   OR
  .dhw 0x____ # 0x____ 0x____   SP@
  .dhw 0x____ # 0x____ 0x____   ibm1442_punch_column_IOCC2
  .dhw 0x____ # 0x____ 0x____   (IO)_DROP
  .dhw 0x____ # 0x____ 0x____   ibm1442_columns_left
  .dhw 0x____ # 0x____ 0x____   1-!
  .dhw 0x000F # 0x____ 0x000F   EXIT

  .dhw 0x____ # 0x____ 0x____   FALSE     : ibm1442_start_punch_new_card
  .dhw 0x____ # 0x____ 0x____   ibm1442_ctrl_start_punch_IOCC2
  .dhw 0x____ # 0x____ 0x____   (IO)_DROP
  .dhw 0x____ # 0x____ 0x____   80_const
  .dhw 0x____ # 0x____ 0x____   1-
  .dhw 0x____ # 0x____ 0x____   ibm1442_columns_left
  ...
  .dhw 0x____ # 0x____ 0x____   MIN      ( start length min )
  .dhw 0x0008 # 0x____ 0x0008   DUP      ( start length min min )   
  .dhw 0x000C # 0x____ 0x000C   >R       ( start length min ) R:( count )
  .dhw 0x____ # 0x____ 0x____   -        ( start length-min )
  .dhw 0x000A # 0x____ 0x000A   SWAP     ( length-min start )
  ...
  .dhw 0x____ # 0x____ 0x____   ibm1442_punch
  .dhw 0x____ # 0x____ 0x____   (JMP)
  .dhw 0x____ # 0x____ 0x____   MEMDUMP_TO_CARDSTACK_L3
  .dhw 0x____ # 0x____ 0x____   CARD_NR   : MEMDUMP_TO_CARDSTACK_L4
  .dhw 0x0006 # 0x____ 0x0006   @
  ...
  .dhw 0x____ # 0x____ 0x____   (BRZ)
  .dhw 0x____ # 0x____ 0x____   MEMDUMP_TO_CARDSTACK_L0
  ...
  .dhw 0x____ # 0x____ 0x____   (CONST)   : papertape_punch_IOCC2
  .dhw 0x1900 # 0x____ 0x1900

  .dhw 0x____ # 0x____ 0x____   0xFF&   : papertape_punch_byte ( byte -- )
  .dhw 0x____ # 0x____ 0x____   8<<>
  .dhw 0x____ # 0x____ 0x____   SP@
  .dhw 0x____ # 0x____ 0x____   papertape_punch_IOCC2
  .dhw 0x____ # 0x____ 0x____   wait_until_papertape_punch_ready
  .dhw 0x____ # 0x____ 0x____   (IO)_DROP
  .dhw 0x000F # 0x____ 0x000F   EXIT

  .dhw 0x0008 # 0x____ 0x0008   DUP  : papertape_punch_cell ( cell -- )
  .dhw 0x____ # 0x____ 0x____   8<<>
  .dhw 0x____ # 0x____ 0x____   papertape_punch_byte
  .dhw 0x____ # 0x____ 0x____   papertape_punch_byte
  .dhw 0x000F # 0x____ 0x000F   EXIT
  
  .dhw 0x000C # 0x____ 0x000C   >R   : MEMDUMP_TO_PAPERTAPE ( start_address length -- )
  .dhw 0x____ # 0x____ 0x____   (JMP)
  .dhw 0x____ # 0x____ 0x____   MEMDUMP_TO_PAPERTAPE_L1
  .dhw 0x0008 # 0x____ 0x0008   DUP   : MEMDUMP_TO_PAPERTAPE_L0
  .dhw 0x0006 # 0x____ 0x0006   @
  .dhw 0x____ # 0x____ 0x____   papertape_punch_cell
  .dhw 0x0005 # 0x____ 0x0005   1+
  .dhw 0x____ # 0x____ 0x____   (NEXT)   : MEMDUMP_TO_PAPERTAPE_L1
  .dhw 0x____ # 0x____ 0x____   MEMDUMP_TO_PAPERTAPE_L0
  .dhw 0x0009 # 0x____ 0x0009   DROP
  .dhw 0x000F # 0x____ 0x000F   EXIT
