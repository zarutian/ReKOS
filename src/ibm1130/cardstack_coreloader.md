...
column 0: 0b        xxxx .... 0x__   0x0000
       1: 0b        xxxx x..x 0x  __ 0x0000 0b                  LD_s I+read_a_card_IOCC_const
       2: 0b        xxxx xxxx 0x__   0x0001
       3: 0b        xxxx x..x 0x  __ 0x0001 0b                  STO_l
       4: 0b        xxxx .... 0x__   0x0002
       5: 0b        xxxx xxxx 0x  __ 0x0002 
       6: 0b        xxxx .x.x 0x__   0x0003
       7: 0b        xxxx ..x. 0x  __ 0x0003 
       8: 0b        xxxx .... 0x__   0x0004
       9: 0b        xxxx xxxx 0x  __ 0x0004 0b                   XIO I+unmask_IOCC      # unmask external interrupts
      ...
      27: 0b        xxxx .xx. 0x  __ 0x000D 0b                  LDX_l XR1        # load Read A Card IOCC1, the address of the first column of the card, into XR1
      28: 0b        xxxx x..x 0x__   0x000E
      29: 0b        xxxx .xx. 0x  __ 0x000E 0b                  read_a_card_IOCC
      30: 0b        xxxx .... 0x__   0x000F
      31: 0b        xxxx .... 0x  __ 0x000F 0b                  LD_s XR1+0       # read the column into the accumulator
      32: 0b        xxxx .... 0x__   0x0010
      33: 0b        xxxx .... 0x  __ 0x0010 0b                  AND_s I+const_bit12_set
      34: 0b        xxxx .... 0x__   0x0011
      35: 0b        xxxx .... 0x  __ 0x0011 0b                  BSC
      36: 0b        xxxx .... 0x__   0x0012
      37: 0b        xxxx .... 0x  __ 0x0012
      38: 0b        xxxx .... 0x__   0x0013
      39: 0b        xxxx .... 0x  __ 0x0013
      40: 0b        xxxx .... 0x__   0x0014
      41: 0b        xxxx .... 0x  __ 0x0014
      42: 0b        xxxx .... 0x__   0x0015
      43: 0b        xxxx .... 0x  __ 0x0015
      44: 0b        xxxx .... 0x__   0x0016
      45: 0b        xxxx .... 0x  __ 0x0016
      46: 0b        xxxx .... 0x__   0x0017
      47: 0b        xxxx .... 0x  __ 0x0017
      48: 0b        xxxx .... 0x__   0x0018
      49: 0b        xxxx .... 0x  __ 0x0018
      50: 0b        xxxx .... 0x__   0x0019
      51: 0b        xxxx .... 0x  __ 0x0019
      52: 0b        xxxx .... 0x__   0x001A
      53: 0b        xxxx .... 0x  __ 0x001A
      54: 0b        xxxx .... 0x__   0x001B
      55: 0b        xxxx .... 0x  __ 0x001B
      56: 0b        xxxx .... 0x__   0x001C
      57: 0b        xxxx .... 0x  __ 0x001C
      58: 0b        xxxx .... 0x__   0x001D
      59: 0b        xxxx .... 0x  __ 0x001D
      60: 0b        xxxx .... 0x__   0x001E
      61: 0b        xxxx .... 0x  __ 0x001E
      62: 0b        xxxx .... 0x__   0x001F
      63: 0b        xxxx .... 0x  __ 0x001F
      64: 0b        xxxx .... 0x__   0x0020
      65: 0b        xxxx .... 0x  __ 0x0020
      66: 0b        xxxx .... 0x__   0x0021
      67: 0b        xxxx .... 0x  __ 0x0021
      68: 0b        xxxx .... 0x__   0x0022
      69: 0b        xxxx .... 0x  __ 0x0022
      70: 0b        xxxx .... 0x__   0x0023
      71: 0b        xxxx .... 0x  __ 0x0023
      72: 0b        xxxx .... 0x__   0x0024
      73: 0b        xxxx .... 0x  __ 0x0024
      74: 0b        xxxx .... 0x__   0x0025
      75: 0b        xxxx .... 0x  __ 0x0025
      76: 0b        xxxx .... 0x__   0x0026
      77: 0b        xxxx .... 0x  __ 0x0026
      78: 0b100100000000      0x900  0x0027                                       # 'A'                                                 # gets replaced by loader card 1
      79: 0b000010000000      0x080  0x0027                                       # '2'                                                 # gets replaced by loader card 1
    END OF CARD
...
const t2 = t1.split("\n").slice(1);
const t3 = t2.map((item) => item.trimLeft().split(" "));
const t4 = t3.map((item) => [item[0].slice(0, -1), item[2], item[3].slice(2)]);
const t5 = t4.reduce((state, item, idx) => {
  var [columnr, labelbits, data] = item;
  const [last_labelbits, result] = state;
  labelbits = parseInt(labelbits.replaceAll(".", "0").replaceAll("x", "1").replaceAll("X", "1"), 2);
  data = parseInt(data, 16) ^ (last_labelbits << 8);
  result.push(data);
  return [labelbits, result];
}, [0, []])[1];
const t6 = t6;
const t7 = t6.map((item) => item.toString(2).padStart(12, "0"));
const t8 = t7.map(f);
