...
column 0: 0b000000000000 0x000 0x005D 0b00000000________  0x00__
      ...
      16: 0b000100000000 0x100 0x0065 0b00010000________
      17: 0b000010000000 0x080 0x0065 0b________00001000  SLA_s  8          # shift left by 8 bits
      18: 0b110101010000 0xD50 0x0066 0b11010101________
      19: 0b100000000000 0x800 0x0066 0b________10000000  STO_li (X1+1)     # store the now half cell B
      20: 0b000000000000 0x000 0x0067 0b00000000________  0x00__
      21: 0b000000010000 0x010 0x0067 0b________00000000  0x__01
      22: 0b110001010000 0xC50 0x0068 0b11000101________
      23: 0b100000000000 0x800 0x0068 0b________10000000  LD_li  (X1+2)     # load cell C
      24: 0b000000000000 0x000 0x0069 0b00000000________  0x00__
      25: 0b000000100000 0x020 0x0069 0b________00000010  0x__02
      26: 0b000110000000 0x180 0x006A 0b00011000________
      27: 0b000010000000 0x080 0x006A 0b________00001000  SRA_s  8          # shift right by 8 bits
      28: 0b111011010000 0xED0 0x006B 0b11101101________
      ...
      32: 0b110101010000 0xD50 0x006D 0b11010101________
      33: 0b100000000000 0x800 0x006D 0b________10000000  STO_li (X1+1)     #  store now full cell B
      ...
      37: 0b100000000000 0x800 0x006F 0b________10000000  LD_li  (X1+2)     #  load cell C again
      ...
      43: 0b100000000000 0x800 0x0072 0b________10000000  STO_li (X1+2)     #  store it back
      44: 0b000000000000 0x000 0x0073 0b00000000________  0x00__
      45: 0b000000100000 0x020 0x0073 0b________00000010  0x__02
      46: 0b110001010000 0xC50 0x0074 0b11000101________  
      47: 0b100000000000 0x800 0x0074 0b________10000000  LD_li  (X1+3)     #  load cell D
      ...
      51: 0b100000000000 0x800 0x0076 0b________10000000  OR_li  (X1+2)     #  or it with what is left of cell C
      ...
      55: 0b100000000000 0x800 0x0078 0b________          STO_li (X1+2)     #   store cell C and D back
      ...
      59: 0b000000000000 0x000 0x007A 0b________00000000  LD_l              #  load the address part of the Read IOCC into the accumulator
      60: 0b000000000000 0x000 0x007B 0b00000000________  0x00__
      61: 0b001011100000 0x2E0 0x007B 0b________00101110  0x__2E
      62: 0b100100000000 0x900 0x007C 0b10010000________
      63: 0b000001010000 0x050 0x007C 0b________00000101  MINUS_l IA+5      #  decr by one
      ...
      67: 0b001011100000 0x2E0 0x007E 0b________
