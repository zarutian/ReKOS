...
const src3 = `
  ...
  .db 0x04  #
  .db 0x00  #
  .db 0x00  # 0x0000 0x6400   LDX_l IA
  .db 0x00  #
  .db 0x00  #
  .db 0x02  #
  .db 0x00  # 0x0001 0x0020   ibm1130_papertape_loader   : XR1
  .db 0x0_  #
  .db 0x0_  #
  .db 0x0_  #
  .db 0x0_  # 0x0002 0x____   : XR2 
  .db 0x0_  #
  .db 0x0_  #
  .db 0x0_  #
  .db 0x0_  # 0x0003 0x____   : XR3  cell addr
  .db 0x0_  #
  .db 0x0_  #
  .db 0x0_  #
  .db 0x0_  # 0x0004 0x____   cell count
  .db 0x0_  #
  .db 0x0_  #
  .db 0x0_  #
  .db 0x0_  # 0x0005 0x____   tmp
  .db 0x0_  #
  .db 0x0_  #
  .db 0x0_  #
  .db 0x0_  # 0x0006 0x____
  .db 0x0_  #
  .db 0x0_  #
  .db 0x0_  #
  .db 0x0_  # 0x0007 0x____
  .db 0x0_  #
  .db 0x0_  #
  .db 0x0_  #
  .db 0x0_  # 0x0008 0x____
  .db 0x0_  #
  .db 0x0_  #
  .db 0x0_  #
  .db 0x0_  # 0x0009 0x____
  .db 0x0_  #
  .db 0x0_  #
  .db 0x0_  #
  .db 0x0_  # 0x000A 0x____
  .db 0x0_  #
  .db 0x0_  #
  .db 0x0_  #
  .db 0x0_  # 0x000B 0x____
  .db 0x00  #
  .db 0x00  #
  .db 0x02  #
  .db 0x06  # 0x000C 0x0026   ibm1130_papertape_loader_intrpLvl4_hndlr
  .db 0x0_  #
  .db 0x0_  #
  .db 0x0_  #
  .db 0x0_  # 0x000D 0x____
  .db 0x0_  #
  .db 0x0_  #
  .db 0x0_  #
  .db 0x0_  # 0x000E 0x____
  .db 0x0_  #
  .db 0x0_  #
  .db 0x0_  #
  .db 0x0_  # 0x000F 0x____
  .db 0x0_  #
  .db 0x0_  #
  .db 0x0_  #
  .db 0x0_  # 0x0010 0x____
  .db 0x0_  #
  .db 0x0_  #
  .db 0x0_  #
  .db 0x0_  # 0x0011 0x____
  .db 0x0_  #
  .db 0x0_  #
  .db 0x0_  #
  .db 0x0_  # 0x0012 0x____
  .db 0x0_  #
  .db 0x0_  #
  .db 0x0_  #
  .db 0x0_  # 0x0013 0x____
  .db 0x0_  #
  .db 0x0_  #
  .db 0x0_  #
  .db 0x0_  # 0x0014 0x____
  .db 0x0_  #
  .db 0x0_  #
  .db 0x0_  #
  .db 0x0_  # 0x0015 0x____
  .db 0x0_  #
  .db 0x0_  #
  .db 0x0_  #
  .db 0x0_  # 0x0016 0x____
  .db 0x0_  #
  .db 0x0_  #
  .db 0x0_  #
  .db 0x0_  # 0x0017 0x____
  .db 0x0_  #
  .db 0x0_  #
  .db 0x0_  #
  .db 0x0_  # 0x0018 0x____
  .db 0x00  #
  .db 0x00  #
  .db 0x00  #
  .db 0x00  # 0x0019 0x0000   IOCC_1stCell zero
  .db 0x00  #
  .db 0x03  #
  .db 0x00  #
  .db 0x00  # 0x001A 0x0300   IOCC_2ndCell Sense Interrupt
  .db 0x0_  #
  .db 0x0_  #
  .db 0x0_  #
  .db 0x0_  # 0x001B 0x____   : bytebuff
  .db 0x00  #
  .db 0x00  #
  .db 0x01  #
  .db 0x0B  # 0x001C 0x001B   IOCC_1stCell bytebuff
  .db 0x01  #
  .db 0x0A  #
  .db 0x00  #
  .db 0x00  # 0x001D 0x1A00   IOCC_2ndCell papertape Read
  .db 0x01  #
  .db 0x0C  #
  .db 0x00  #
  .db 0x00  # 0x001F 0x1C00   IOCC_2ndCell papertape Control
  .db 0x00  #
  .db 0x08  #
  .db 0x0F  #
  .db 0x0C  # 0x0020 0x08FC   XIO_s IA-4  do pt Control  : ibm1130_papertape_loader
  .db 0x03  #
  .db 0x00  #
  .db 0x00  #
  .db 0x00  # 0x0021 0x3000   WAIT
  .db 0x06  #
  .db 0x04  #
  .db 0x00  #
  .db 0x00  # 0x0022 0x6400   LDX_l IA
  .db 0x00  #
  .db 0x00  #
  .db 0x02  #
  .db 0x00  # 0x0023 0x0020   ibm1130_papertape_loader
  .db 0x06  #
  .db 0x04  #
  .db 0x00  #
  .db 0x00  # 0x0024 0x6400   LDX_l IA
  .db 0x00  #
  .db 0x00  #
  .db 0x00  #
  .db 0x00  # 0x0025 0x0000   InterruptServiceRoutine saved IA
  .db 0x0D  #
  .db 0x04  #
  .db 0x00  #
  .db 0x00  # 0x0026 0xD400   STO_l    : ibm1130_papertape_loader_intrpLvl4_hndlr
  .db 0x00  #
  .db 0x00  #
  .db 0x00  #
  .db 0x05  # 0x0027 0x0005   tmp
  .db 0x00  #
  .db 0x0C  #
  .db 0x00  #
  .db 0x00  # 0x0028 0x0C00   XIO_l  do Sense Interrupts
  .db 0x00  #
  .db 0x00  #
  .db 0x01  #
  .db 0x09  # 0x0029 0x0019   address of Sense Interrupts IOCC
  .db 0x0_  #
  .db 0
