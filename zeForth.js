...
const src3 = `
  ...
  .dhw 0x____ # 0x0045 0x____   : (SP0)
  .dhw 0x____ # 0x0046 0x____   : (RP0)
  ...
  .dhw 0xB030 # 0x02CE 0xB030   NUL
  .dhw 0x0000 # 0x02CF 0x0000   ASCII NULl
  .dhw 0x9010 # 0x02D0 0x9010   SOH
  .dhw 0x0001 # 0x02D1 0x0001   ASCII StartOfHeader
  .dhw 0x8810 # 0x02D2 0x8810   STX
  .dhw 0x0002 # 0x02D3 0x0002   ASCII Start of TeXt
  .dhw 0x8410 # 0x02D4 0x8410   ETX
  .dhw 0x0003 # 0x02D5 0x0003   ASCII End of TeXt
  .dhw 0x8110 # 0x02D6 0x8110   HT
  .dhw 0x0009 # 0x02D7 0x0009   ASCII TAB
  .dhw 0x8050 # 0x02D8 0x8050   DEL
  .dhw 0x007F # 0x02D9 0x007F   ASCII DEL
  .dhw 0x8430 # 0x02DA 0x8430   VT
  .dhw 0x000B # 0x02DB 0x000B   ASCII Vertical Tab
  .dhw 0x8230 # 0x02DC 0x8230   FF
  .dhw 0x000C # 0x02DD 0x000C   ASCII Form Feed  (often used as CLear Screen)
  .dhw 0x8130 # 0x02DE 0x8130   CR
  .dhw 0x000D # 0x02DF 0x000D   ASCII Carrage Return
  .dhw 0x80B0 # 0x02E0 0x80B0   SO
  .dhw 0x000E # 0x02E1 0x000E   ASCII Shift Out
  .dhw 0x8070 # 0x02E2 0x8070   SI
  .dhw 0x000F # 0x02E3 0x000F   ASCII Shift In
  .dhw 0xD030 # 0x02E4 0xD030   DLE
  .dhw 0x0010 # 0x02E5 0x0010   ASCII Data Link Escape
  .dhw 0x5010 # 0x02E6 0x5010   DC1
  .dhw 0x0011 # 0x02E7 0x0011   ASCII Device Control 1
  .dhw 0x4810 # 0x02E8 0x4810   DC2
  .dhw 0x0012 # 0x02E9 0x0012   ASCII Device Control 2
  .dhw 0x4410 # 0x02EA 0x4410   DC3
  .dhw 0x0013 # 0x02EB 0x0013   ASCII Device Control 3
  .dhw 0x4110 # 0x02EC 0x4110   NL
  .dhw 0x000A # 0x02ED 0x000A   ASCII New Line
  .dhw 0x4090 # 0x02EE 0x4090   BS
  .dhw 0x0008 # 0x02EF 0x0008   ASCII BackSpace
  .dhw 0x4050 # 0x02F0 0x4050   IDL  idle
  .dhw 0x0016 # 0x02F1 0x0016   ASCII SYNchronous idle
  .dhw 0x4030 # 0x02F2 0x4030   CAN
  .dhw 0x0018 # 0x02F3 0x0018   ASCII CANcel
  .dhw 0x5030 # 0x02F4 0x5030   EM
  .dhw 0x0019 # 0x02F5 0x0019   ASCII End of Medium
  .dhw 0x2130 # 0x02F6 0x2130   ENQ
  .dhw 0x0005 # 0x02F7 0x0005   ASCII ENQuiry
  .dhw 0x20B0 # 0x02F8 0x20B0   ACK
  .dhw 0x0006 # 0x02F9 0x0006   ASCII ACKnowledge
  .dhw 0x2070 # 0x02FA 0x2070   BEL
  .dhw 0x0007 # 0x02FB 0x0007   ASCII BELl
  .dhw 0x0810 # 0x02FC 0x0810   SYN
  .dhw 0x0016 # 0x02FD 0x0016   ASCII SYNchronous idle
  .dhw 0x0050 # 0x02FE 0x0050   ETB
  .dhw 0x0017 # 0x02FF 0x0017   ASCII End of Transmission Block
  .dhw 0x0130 # 0x0300 0x0130   NAK
  .dhw 0x0015 # 0x0301 0x0015   ASCII Negative AcKnowledge
  .dhw 0x0070 # 0x0302 0x0070   SUB
  .dhw 0x001A # 0x0303 0x001A   ASCII SUBstitude
  .dhw 0x0000 # 0x0304 0x0000   space
  .dhw 0x0020 # 0x0305 0x0020   ASCII space
  .dhw 0x8820 # 0x0306 0x8820   ¢
  .dhw 0x00__ # 0x0307 0x00__   ?? utf-8?
  ...
  .dhw 0x0___ # 0x03AA 0x0___   (VAR)   : console_kb
  .dhw 0x0000 # 0x03AB 0x0000   0xXXYY  XX=0x00|0xFF  YY=ascii_char
  .dhw 0x0___ # 0x03AC 0x0___   console_keyboard_ctrl_IOCC  ( addr ) : console_keyboard_ISR
  ...
  .dhw 0x0___ # 0x03B6 0x0___   =
  .dhw 0x014F # 0x03B7 0x014F   (BRZ)
  .dhw 0x0___ # 0x03B8 0x03B0
  .dhw 0x0___ # 0x03B9 0x0___   FALSE
  .dhw 0x0___ # 0x03BA 0x0___   SP@
  .dhw 0x0___ # 0x03BB 0x0___   console_keyboard_read_IOCC2
  .dhw 0x0006 # 0x03BC 0x0006   @
  .dhw 0x0___ # 0x03BD 0x0___   (IO)
  .dhw 0x0009 # 0x03BE 0x0009   DROP
  .dhw 0x0___ # 0x03BF 0x0___   IBM_CARDCODE2ASCII
  .dhw 0x0___ # 0x03C0 0x0___   0xFF_const
  .dhw 0x0___ # 0x03C1 0x0___   8<<>
  .dhw 0x0___ # 0x03C2 0x0___   OR
  .dhw 0x0___ # 0x03C3 0x0___   console_kb
  .dhw 0x0007 # 0x03C4 0x0007   !
  .dhw 0x000F # 0x03C5 0x000F   EXIT
  .dhw 0x0___ # 0x03C6 0x0___   console_kb   : console_?RX ( -- char T | F )
  .dhw 0x0006 # 0x03C7 0x0006   @
  .dhw 0x0008 # 0x03C8 0x0008   DUP
  .dhw 0x0___ # 0x03C9 0x0___   8<<>
  .dhw 0x0___ # 0x03CA 0x0___   0xFF&
  .dhw 0x014F # 0x03CB 0x014F   (BRZ)
  .dhw 0x0___ # 0x03CC 0x0___
  .dhw 0x0___ # 0x03CD 0x0___   0xFF&
  .dhw 0x0___ # 0x03CE 0x0___   FALSE
  .dhw 0x0___ # 0x03CF 0x0___   console_kb
  .dhw 0x0007 # 0x03D0 0x0007   !
  .dhw 0x0___ # 0x03CE 0x0___   (JMP)
  .dhw 0x0___ # 0x03CF 0x0___   TRUE
  .dhw 0x0009 # 0x03D0 0x0009   DROP
  .dhw 0x0___ # 0x03D1 0x0___   (JMP)
  .dhw 0x0___ # 0x03D2 0x0___   FALSE
