...
const src3 = `
  ...
  .dhw 0x03CE # 0x047F 0x03CE   BSC_tx_addr   : BSC_send ( addr length -- )
  .dhw 0x0005 # 0x0480 0x0005   1+
  .dhw 0x0006 # 0x0481 0x0006   @
  .dhw 0x0___ # 0x0482 0x0___   (BRZ)     wait for previous send to finish first
  .dhw 0x0486 # 0x0483 0x0486
  .dhw 0x0___ # 0x0484 0x0___   (JMP)
  .dhw 0x047F # 0x0485 0x047F
  .dhw 0x03CE # 0x0486 0x03CE   BSC_tx_addr
  .dhw 0x0___ # 0x0487 0x0___   D!

  
  .dhw 0x0419 # 0x04__ 0x0419   SCA_ISR_status
  .dhw 0x0006 # 0x04__ 0x0006   @
  .dhw 0x0___ # 0x04__ 0x0___   1_const
  .dhw 0x0002 # 0x04__ 0x0002   &
  .dhw 0x0___ # 0x04__ 0x0___   (BRZ)
  .dhw 0x04__ # 0x048D 0x04__
  
  .dhw 0x0___ # 0x04__ 0x0___   FALSE
  .dhw 0x0___ # 0x04__ 0x0___   BSC_init_write_IOCC2
  .dhw 0
