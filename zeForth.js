...
const src3 = `
  ...
  .dhw 0x100A # 0x02CF 0x100A   ASCII New Line + 0x800ð
  ...
  .dhw 0x01A0 # 0x03AA 0x01A0   (VAR)   : console_kb
  .dhw 0x0000 # 0x03AB 0x0000   0xXXYY  XX=0x00|0xFF|0x7F YY=ascii_char
  .dhw 0x03A7 # 0x03AC 0x03A7   console_keyboard_ctrl_IOCC  ( addr ) : console_keyboard_ISR
