...
const src3 = `
  ...
  .db 0x0_ 0x0_ 0x0_ 0x0_ # 0x002C 0x____   branch target
  .db 0x00 0x0C 0x00 0x00 # 0x002D 0x0C00   XIO_l  do papertape read
  .db 0x00 0x00 0x01 0x0C # 0x002E 0x001C   address of IOCC
  .db 0x0C 0x04 0x00 0x00 # 0x002F 0xC400   LD     load accumulator from cell count
  .db 0x00 0x00 0x00 0x04 # 0x0030 0x0004   address of byte count
  .db 0x0E 0x04 0x00 0x00 # 0x0031 0xE400   AND_l
  .db 0x00 0x00 0x01 0x08 # 0x0032 0x0018   address of constant 1
  .db 0x04 0x0C 0x02 0x00 # 0x0033 0x4C20   BRanch if accumulator is Zero
  .db 0x0_ 0x0_ 0x0_ 0x0_ # 0x0034 0x____   branch target
