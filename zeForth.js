...
const src3 = `
  ...
  .dhw 0x____ # 0x0097 0x____   (ibm1130)
  ...
  .dhw 0x____ # 0x00A3 0x____   (ibm1130)
  ...
  .dhw 0x____ # 0x00AA 0x___    (ibm1130)
  ...
  .dhw 0x____ # 0x00AF 0x____   (ibm1130)
  ...
  .dhw 0x____ # 0x00B4 0x____   (ibm1130)
  .dhw 0xC2FF # 0x00B5 0x____   LD_s XR2-1   : 1<<>_ibm1130
  ...
  .dhw 0x____ # 0x00BD 0x____   (ibm1130)
  ...
  .dhw 0x____ # 0x00C5 0x____   (ibm1130)
  ...
  .dhw 0x____ # 0x00D2 0x____   (ibm1130)
  ...
  .dhw 0x____ # 0x00EA 0x____   (ibm1130)
  ...
  .dhw 0x____ # 0x00F8 0x____   (ibm1130)
  ...
  .dhw 0x____ # 0x0103 0x____   (ibm1130)
  ...
  .dhw 0x____ # 0x010D 0x____   (ibm1130)
  ...
  .dhw 0x____ # 0x0118 0x____   (ibm1130)
  ...
  .dhw 0x____ # 0x01B0 0x____   ASCII2CONSOLE_PRINTER_CODE   : console_TX!  ( char -- )
  ...
  .dhw 0x2600 # 0x025B 0x2600   H
  .dhw 0x0049 # 0x025C 0x0049   I
  .dhw 0x2200 # 0x025D 0x2200   I
  .dhw 0x004A # 0x025E 0x004A   J
  .dhw 0xCE00 # 0x025F 0xCE00   J
  .dhw 0x004B # 0x0260 0x004B   K
  .dhw 0x5A00 # 0x0261 0x5A00   K
  .dhw 0x004C # 0x0262 0x004C   L
  .dhw 0x5E00 # 0x0263 0x5E00   L
  .dhw 0x004D # 0x0264 0x004C   M
  .dhw 0x7200 # 0x0265 0x7200   M
  .dhw 0x004E # 0x0266 0x004E   N
  .dhw 0x7600 # 0x0267 0x7600   N
  .dhw 0x004F # 0x0268 0x004F   O
  .dhw 0x5200 # 0x0269 0x5200   O
  .dhw 0x0050 # 0x026A 0x0050   P
  .dhw 0x5600 # 0x026B 0x5600   P
  ...
  .dhw 0x0000 # 0x01CD 0x0000   NUL
  .dhw 0x0100 # 0x01CE 0x0100   SOH
  .dhw 0x0200 # 0x01CF 0x0200   STX
  .dhw 0x0300 # 0x01D0 0x0300   ETX
  .dhw 0x3700 # 0x01D1 0x3700   EOT
  .dhw 0x2D00 # 0x01D2 0x2D00   ENQ
  .dhw 0x2E00 # 0x01D3 0x2E00   ACK
  .dhw 0x2F00 # 0x01D4 0x2F00   BEL
  .dhw 0x1600 # 0x01D5 0x1600   BS
  .dhw 0x0500 # 0x01D6 0x0500   TAB
  .dhw 0x2500 # 0x01D7 0x2500   LF
  .dhw 0x0B00 # 0x01D8 0x0B00   VT
  .dhw 0x0C00 # 0x01D9 0x0C00   FF
  .dhw 0x0D00 # 0x01DA 0x0D00   CR
  .dhw 0x0E00 # 0x01DB 0x0E00   SO
  .dhw 0x0F00 # 0x01DC 0x0F00   SI
  .dhw 0x1000 # 0x01DD 0x1000   DLE
  .dhw 0x1100 # 0x01DE 0x1100   DC1
  .dhw 0x1200 # 0x01DF 0x1200   DC2
  .dhw 0x1300 # 0x01E0 0x1300   DC3
  .dhw 0xFFFE # 0x01E1 0xFFFF   DC4  EBDIC doesnt seem to have DC4
  .dhw 0x3D00 # 0x01E2 0x3D00   NAK
  .dhw 0x3200 # 0x01E3 0x3200   SYN
  .dhw 0x2600 # 0x01E4 0x2600   ETB
  .dhw 0x1800 # 0x01E5 0x1800   CAN
  .dhw 0x1900 # 0x01E6 0x1900   EM
  .dhw 0x3F00 # 0x01E7 0x3F00   SUB
  .dhw 0xFFFD # 0x01E8 0xFFFE   ESC  EBDIC doesnt seem to have ESC
  .dhw 0x2200 # 0x01E9 0x2200   FS
  .dhw 0x1D00 # 0x01EA 0x1D00   GS
  .dhw 0x1E00 # 0x01EB 0x1E00   RS
  .dhw 0x1F00 # 0x01EC 0x1F00   US
  .dhw 0x4000 # 0x01ED 0x4000   Space
  .dhw 0x5A00 # 0x01EF 0x5A00   !
  .dhw 0x7F00 # 0x01F0 0x7F00   "
  .dhw 0x7B00 # 0x01F1 0x7B00   #   nabbi eða nabbamark
  .dhw 0x5B00 # 0x01F2 0x5B00   $
  .dhw 0x6C00 # 0x01F3 0x6C00   %
  .dhw 0x5000 # 0x01F4 0x5000   &
  .dhw 0x7D00 # 0x01F5 0x7D00   '
  .dhw 0x4D00 # 0x01F6 0x4D00   (
  .dhw 0x5D00 # 0x01F7 0x5D00   )
  .dhw 0x5C00 # 0x01F8 0x5C00   *
  .dhw 0x4E00 # 0x01F9 0x4E00   +
  .dhw 0x6B00 # 0x01FA 0x6B00   ,
  .dhw 0x6000 # 0x01FB 0x6000   -
  .dhw 0x4B00 # 0x01FC 0x4B00   .
  .dhw 0x6100 # 0x01FD 0x6100   /
  .dhw 0xF000 # 0x01FE 0xF000   0
  .dhw 0xF100 # 0x01FF 0xF100   1
  .dhw 0xF200 # 0x0200 0xF200   2
  .dhw 0xF300 # 0x0201 0xF300   3
  .dhw 0xF400 # 0x0202 0xF400   4
  .dhw 0xF500 # 0x0203 0xF500   5
  .dhw 0xF600 # 0x0204 0xF600   6
  .dhw 0xF700 # 0x0205 0xF700   7
  .dhw 0xF800 # 0x0206 0xF800   8
  .dhw 0xF900 # 0x0207 0xF900   9
  .dhw 0x7A00 # 0x0208 0x7A00   :
  .dhw 0x5E00 # 0x0209 0x5E00   ;
  .dhw 0x4C00 # 0x020A 0x4C00   <
  .dhw 0x7E00 # 0x020B 0x7E00   =
  .dhw 0x6E00 # 0x020C 0x6E00   >
  .dhw 0x6F00 # 0x020D 0x6F00   ?
  .dhw 0x7C00 # 0x020E 0x7C00   @
  .dhw 0xC100 # 0x020F 0xC100   A
  .dhw 0xC200 # 0x0210 0xC200   B
  .dhw 0xC300 # 0x0211 0xC300   C
  .dhw 0xC400 # 0x0212 0xC400   D
  .dhw 0xC500 # 0x0213 0xC500   E
  .dhw 0xC600 # 0x0214 0xC600   F
  .dhw 0xC700 # 0x0215 0xC700   G
  .dhw 0xC800 # 0x0216 0xC800   H
  .dhw 0xC900 # 0x0217 0xC900   I
  .dhw 0xD100 # 0x0218 0xD100   J
