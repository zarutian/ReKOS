...
const src3 = `
  ...
  .dhw 0x0___ # 0x0432 0x0___   SP@
  .dhw 0x042A # 0x0433 0x042A   BSC_set_syncchar_IOCC2
  .dhw 0x0___ # 0x0434 0x0___   (IO)
  .dhw 0x0009 # 0x0435 0x0009   DROP           SYNc char set
  .dhw 0x0___ # 0x0436 0x0___   FALSE
  .dhw 0x0428 # 0x0437 0x0428   BSC_ctrl_IOCC2
  .dhw 0x0___ # 0x0438 0x0___   0x14_const
  .dhw 0x0___ # 0x0439 0x0___   OR
  .dhw 0x0___ # 0x043A 0x0___   (IO)
  .dhw 0x0009 # 0x043B 0x0009   DROP           SCA modes set
  .dhw 0x0___ # 0x043C 0x0___   (LIT)
  .dhw 0x03D6 # 0x043D 0x03D6
  .dhw 0x0___ # 0x043E 0x0___   (LIT)
