...
const src3 = `
  ...
  .db 0x00 0x00 0x02 0x00 # 0x0001 0x0020   ibm1130_papertape_loader   : XR1
  .db 0x0_ 0x0_ 0x0_ 0x0_ # 0x0002 0x____   : XR2 
  .db 0x0_ 0x0_ 0x0_ 0x0_ # 0x0003 0x____   : XR3  cell addr
  .db 0x0_ 0x0_ 0x0_ 0x0_ # 0x0004 0x____   byte count
  .db 0x0_ 0x0_ 0x0_ 0x0_ # 0x0005 0x____   tmp
  .db 0x0_ 0x0_ 0x0_ 0x0_ # 0x0006 0x____
  .db 0x0_ 0x0_ 0x0_ 0x0_ # 0x0007 0x____
  .db 0x0_ 0x0_ 0x0_ 0x0_ # 0x0008 0x004F
  .db 0x0_ 0x0_ 0x0_ 0x0_ # 0x0009 0x004F
  .db 0x0_ 0x0_ 0x0_ 0x0_ # 0x000A 0x004F
  .db 0x0_ 0x0_ 0x0_ 0x0_ # 0x000B 0x004F
  .db 0x00 0x00 0x02 0x05 # 0x000C 0x0025   ibm1130_papertape_loader_intrpLvl4_hndlr
  .db 0x0_ 0x0_ 0x0_ 0x0_ # 0x000D 0x004F
  .db 0x0_ 0x0_ 0x0_ 0x0_ # 0x000E 0x____
  .db 0x0_ 0x0_ 0x0_ 0x0_ # 0x000F 0x____
  .db 0x0_ 0x0_ 0x0_ 0x0_ # 0x0010 0x____
  .db 0x0_ 0x0_ 0x0_ 0x0_ # 0x0011 0x____
  .db 0x0_ 0x0_ 0x0_ 0x0_ # 0x0012 0x____
  .db 0x0_ 0x0_ 0x0_ 0x0_ # 0x0013 0x____
  .db 0x0_ 0x0_ 0x0_ 0x0_ # 0x0014 0x____
  .db 0x0_ 0x0_ 0x0_ 0x0_ # 0x0015 0x____
  .db 0x0_ 0x0_ 0x0_ 0x0_ # 0x0016 0x____
  .db 0x0_ 0x0_ 0x0_ 0x0_ # 0x0017 0x____
  .db 0x00 0x00 0x00 0x01 # 0x0018 0x0001   constant 0x0001
  .db 0x00 0x00 0x00 0x00 # 0x0019 0x0000   IOCC_1stCell zero
  .db 0x00 0x03 0x00 0x00 # 0x001A 0x0300   IOCC_2ndCell Sense Interrupt
  .db 0x0F 0x0E 0x0E 0x0D # 0x001B 0xFEED   : bytebuff
  .db 0x00 0x00 0x01 0x0B # 0x001C 0x001B   IOCC_1stCell bytebuff
  .db 0x01 0x0A 0x00 0x00 # 0x001D 0x1A00   IOCC_2ndCell papertape Read
  .db 0x01 0x0C 0x00 0x00 # 0x001F 0x1C00   IOCC_2ndCell papertape Control
  .db 0x00 0x08 0x0F 0x0C # 0x0020 0x08FC   XIO_s IA-4  do pt Control  : ibm1130_papertape_loader
  .db 0x03 0x00 0x00 0x00 # 0x0021 0x3000   WAIT
  .db 0x06 0x04 0x00 0x00 # 0x0022 0x6400   LDX_l IA
  .db 0x00 0x00 0x02 0x00 # 0x0023 0x0020   ibm1130_papertape_loader
  .db 0x06 0x04 0x00 0x00 # 0x0024 0x6400   LDX_l IA
  .db 0x00 0x00 0x00 0x00 # 0x0025 0x0000   InterruptServiceRoutine saved IA
  .db 0x0D 0x04 0x00 0x00 # 0x0026 0xD400   STO_l    : ibm1130_papertape_loader_intrpLvl4_hndlr
  .db 0x00 0x00 0x00 0x05 # 0x0027 0x0005   tmp
  .db 0x00 0x0C 0x00 0x00 # 0x0028 0x0C00   XIO_l  do Sense Interrupts
  .db 0x00 0x00 0x01 0x09 # 0x0029 0x0019   address of Sense Interrupts IOCC
  .db 0x01 0x00 0x00 0x01 # 0x002A 0x1001   SLA 1
  .db 0x04 0x0C 0x00 0x02 # 0x002B 0x4C02   Branch to 0x____ if Carry is off
  .db 0x00 0x00 0x0_ 0x0_ # 0x002C 0x00__   branch target
  .db 0x00 0x0C 0x00 0x00 # 0x002D 0x0C00   XIO_l  do papertape read
  .db 0x00 0x00 0x01 0x0C # 0x002E 0x001C   address of IOCC
  .db 0x0C 0x04 0x00 0x00 # 0x002F 0xC400   LD     load accumulator from bytecount
  .db 0x00 0x00 0x00 0x04 # 0x0030 0x0004   address of byte count
  .db 0x04 0x0C 0x00 0x04 # 0x0031 0x4C04   BRanch if accumulator is Even
  .db 0x0_ 0x0_ 0x0_ 0x0_ # 0x0032 0x____   branch target
  .db 0x0C 0x04 0x00 0x00 # 0x0033 0xC400   LD     load accumulator from bytebuff
  .db 0x00 0x00 0x01 0x0B # 0x0034 0x001B   address of bytebuff
  .db 0x01 0x08 0x00 0x08 # 0x0035 0x1808   SRA 8
  .db 0x0E 0x0B 0x00 0x00 # 0x0036 0xEB00   OR_s  XR3+0x00
  .db 0x0D 0x03 0x00 0x00 # 0x0037 0xD300   STO_s XR3+0x00  store cell at cell address
  .db 0x0C 0x04 0x00 0x00 # 0x0038 0xC400   LD     load accumulator with constant 1
  .db 0x00 0x00 0x01 0x08 # 0x0039 0x0018   address of constant 1
  .db 0x08 0x03 0x00 0x00 # 0x003A 0x8300   A XR3+0x00  incr accumulator
  .db 0x0D 0x04 0x00 0x00 # 0x003B 0xD400   STO_l  store in XR3
  .db 0x00 0x00 0x00 0x03 # 0x003C 0x0003   XR3
  .db 0x0C 0x04 0x00 0x00 # 0x003D 0xC400   LD     load accumulator with bytecount
  .db 0x00 0x00 0x00 0x04 # 0x003E 0x0004   address of bytecount
  .db 0x09 0x04 0x00 0x00 # 0x003F 0x9400   S_l    decr accumulator
  .db 0x00 0x00 0x01 0x08 # 0x0040 0x0018   address of constant 1
  .db 0x0D 0x04 0x00 0x00 # 0x0041 0xD400   STO_l  store accumulator into bytecount
  .db 0x00 0x00 0x00 0x04 # 0x0042 0x0004   address of bytecount
  .db 0x04 0x0C 0x02 0x00 # 0x0043 0x4C20   BRAZ
  .db 0x0_ 0x0_ 0x0_ 0x0_ # 0x0044 0x____
  .db 0x0C 0x04 0x00 0x00 # 0x0045 0xC400   LD     load saved accumulator
  .db 0x00 0x00 0x00 0x05 # 0x0046 0x0005   address of tmp
  .db 0x06 0x04 0x00 0x00 # 0x0047 0x6400   LDX_l  jump to ISR exit
  .db 0x00 0x00 0x02 0x04 # 0x0048 0x0024
  .db 0x0C 0x04 0x00 0x00 # 0x0049 0xC400   LD     load accumulator from bytebuff
  .db 0x00 0x00 0x01 0x0B # 0x004A 0x001B   address of bytebuff
  .db 0x0D 0x03 0x00 0x00 # 0x004B 0xD300   STO_s XR3+00  store byte att cell address
  .db 0x06 0x04 0x00 0x00 # 0x004C 0x6400   LDX_l  jump to
  .db 0x00 0x00 0x03 0x0D # 0x004D 0x003D
  .db 0x06 0x04 0x00 0x00 # 0x004E 0x6400   LDX_l  jump to whatever was interrupted
  .db 0x00 0x00 0x00 0x00 # 0x004F 0x0000     as we ignore these interrupts
  .db 0x06 0x04 0x00 0x00 # 0x0050 0x6400   LDX_l
  .db 0x00 0x00 0x04 0x0E # 0x0051 0x004E
  .db 0xFF  # end of first part of IPL program on tape
  .undef 《NO_SYM_LOOKUP》
`;
export { src };
