...
const src3 = `
  ...
  .dhw 0x0___ # 0x0414 0x0___   address of constant 1
  ...
  .dhw 0x01A0 # 0x0424 0x01A0   (VAR)
  .dhw 0x0000 # 0x0425 0x0000   BSC_init_read_IOCC
  .dhw 0x____ # 0x0426 0x____
  .dhw 0x01A0 # 0x0427 0x01A0   (VAR)
  .dhw 0x0000 # 0x0428 0x0000   BSC_init_write_IOCC
  .dhw 0x5540 # 0x0429 0x5540
  .dhw 0x01A0 # 0x042A 0x01A0   (VAR)
  .dhw 0x____ # 0x042B 0x____   BSC_ctrl_IOCC
  .dhw 0x____ # 0x042C 0x____
  .dhw 0x01A0 # 0x042D 0x01A0   (VAR)
  .dhw 0x0000 # 0x042E 0x0000   addr  BSC_rx_addr
  .dhw 0x0000 # 0x042F 0x0000   length
