...
const src3 = `
  ...
  .dhw 0x____ # 0x0089 0x____   &
  .dhw 0x____ # 0x008A 0x____   XOR
  .dhw 0x____ # 0x008B 0x____   1<<>
  .dhw 0x00A4 # 0x008C 0x00A4   1+
  .dhw 0x____ # 0x008D 0x____   @
  ...
  .dhw 0xD2FF # 0x00A7 0xD2FF   STO_s XR2-1
  .dhw 0x6400 # 0x00A8 0x6400   LDX_l
  .dhw 0x0060 # 0x00A9 0x0060   NXT_ibm1130
  .dhw 0x____ # 0x00AA 0x___   (ibm1140)
