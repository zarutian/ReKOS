...
const src3 = `
  ...
  .dhw 0x0___ # 0x03F1 0x0___   branch target
  ...
  .dhw 0x____ # 0x03F4 0x____   AND_l
  .dhw 0x____ # 0x03F4 0x____   address of constant 1
  .dhw 0x____ # 0x03F5 0x____   BRAZ
  .dhw 0x0407 # 0x03F6 0x0407 
  .dhw 0xC400 # 0x03F7 0xC400   LD_l                     we did get the odd nr'ed byted
  .dhw 0x03CF # 0x03F8 0x03CF   address of BSC_rx_addr   get where to put it
  ...
  .dhw 0x6400 # 0x0405 0x6400   LDX_l IA
  .dhw 0x____ # 0x0406 0x____
  .dhw 0xC400 # 0x0407 0xC400   LD_l                     we have not gotted the odd nr'ed byte yet
  .dhw 0x____ # 0x0408 0x____   address of address of SCA_ISR_tmp3
  .dhw 0xD400 # 0x0409 0xD400   STO_l                    so request it
  .dhw 0x____ # 0x040A 0x____   address of BSC_read_IOCC
