...
const src3 = `
  ...
  .dhw 0x0002 # 0x004D 0x0002   cpnstant 2
  ...
  .dhw 0x____ # 0x008F 0x____   DUP
  .dhw 0x____ # 0x0090 0x____   DROP
  .dhw 0x____ # 0x0091 0x____   SWAP
  .dhw 0x____ # 0x0092 0x____   SKZ
  .dhw 0x____ # 0x0093 0x____   >R
  .dhw 0x____ # 0x0094 0x____   R>
  .dhw 0x____ # 0x0095 0x____   EXT
  .dhw 0x____ # 0x0096 0x____   EXIT
  ...
  .dhw 0x6400 # 0x00A1 0x6400   LDX_l
